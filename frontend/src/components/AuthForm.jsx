    ...
    <>
      <form onSubmit={handleSubmit} className="space-y-4">
        <input
          ...
          className="w-full p-2 rounded bg-zinc-800 text-black placeholder-gray-400 border border-zinc-700"
        />
        <input
          value={exercise}
        ...
        {sets.map((set, i) => (
          <div key={i} className="flex space-x-2">
            <input
              ...
              placeholder="Weight"
              className="p-2 rounded bg-zinc-800 text-black placeholder-gray-400 border border-zinc-700 w-1/3"
            />
            <input
              value={set.reps}
